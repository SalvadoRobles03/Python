...
def retroMate():
    print("Retroalimentación de Matemáticas")
    for x in range (10):
        pMate=tMate.groupby("Numero").get_group(mMate[x][0])
        print("------------------------------")
...
def retroEsp():
    print("Retroalimentación de Español")
    for x in range (5):
        pEsp=tEsp.groupby("Numero").get_group(mEsp[x][0])
        print("------------------------------")
        print("Retroalimentación Pregunta #",(x+1))
...
def retroCie():
    print("Retroalimentación de Ciencias")
    for x in range (5):
        pCie=tCie.groupby("Numero").get_group(mCie[x][0])
        print("------------------------------")
        print("Retroalimentación Pregunta #",(x+1))
    ...
    if elección == "2":
      for i in range(16):
          ...
          if minutos==15:
              ...
              separador()
              print("\nTen en consideración que tu tiempo ya ha terminado, pero puedes continuar con la prueba")
...
engine.say("Suerte en tu examen, "+nombre)
engine.runAndWait()
print("El test consta de 3 secciones:")
print(" 1.Matemáticas\n 2.Ciencias Naturales\n 3.Español")
print("Iniciaremos con Matemáticas")
...
engine.say("Gracias por realizar este examen, "+nombre)
engine.runAndWait()
titulos=["Matemáticas (10 Max)", "Ciencias (5 Max)", "Español (5 Max)"]
barlist=plt.bar(titulos,puntos)
